...
<div class="layout-container">
    <header class="header-container">
        <nav>
            ...
            <h2 class="header-title">计量单位列表</h2>
            <ul class="pull-right">
            ...
            <div class="row"> 
                <div class="col-sm-12"> 
                    <div class="card-footer search_box">
                        <a class="btn  btn-primary btn-lg btn-flat pull-left" href="<?= U('Home/Unit/add')?>"><i class="ion-plus mr-sm" style="font-size: 16px;"></i>新增计量单位</a>
                    </div>
                </div> 
            </div> 
        </div>
        ...
        <table class="table table-striped bg-white">
            ...
            <?php foreach($arrUnit as $key => $value):?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary btn-sm" href="<?=U('Unit/update',array('id'=>$value['id']))?>">编辑</a>
                        <a class="btn btn-primary btn-sm" href="<?=U('Unit/delete',array('id'=>$value['id']))?>">删除</a>
                    </td>
                </tr>
            <?php endforeach;?>
            </tbody>
