...
<div class="layout-container">
    <header class="header-container">
        <nav>
            ...
            <h2 class="header-title">新增发货详情</h2>
            <ul class="pull-right">
    ...
    <div class="container-fluid bg-white">
        <form id="w0" class="form-horizontal" action="<?= U('Home/Index/add')?>" method="post" enctype="multipart/form-data" style="margin: 100px 0 0 0">
            ...
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-4">
                    <input class="form-control" type="text" value="" id="datetimepicker" placeholder="请选择发货时间" name="dispatching_time" />
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="check_number"  placeholder="请输入托运单号">
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="check"  placeholder="请输入托运单位及电话">
                    <div class="help-block"></div>
                </div>
            </div>
            ...
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="goods_name"  placeholder="请输入货物名称">
                    <div class="help-block"></div>
                </div>
            </div>
            ...
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="goods_number"  placeholder="请输入数量">
                    <div class="help-block"></div>
                </div>
                <div class="col-sm-2">
            ...
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="consignor"  placeholder="请输入发货人姓名">
                    <div class="help-block"></div>
                </div>
            </div>
            ...
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="receiver"  placeholder="请输入收货人及电话">
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="department"  placeholder="请输入收货人单位">
                    <div class="help-block"></div>
                </div>
            </div>
            ...
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="freight_total"  placeholder="请输入费用总计">
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="form-group field-doctor-password required">
                ...
                <div class="col-sm-4">
                    <textarea class="form-control" name="remark"  placeholder="请输入备注内容">
